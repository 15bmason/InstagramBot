...
class InstaBot:
    def __init__(self, PN, PW):
        ...
        sleep(3)
        self.driver.find_element_by_xpath("/html/body/div[1]/section/div/div[2]/div/div/div[2]/div[2]/div/div[2]/div/div/div[2]/textarea").send_keys("cringe")
        sleep(3)
...
my_bot = InstaBot(secret.PN, secret.PW)